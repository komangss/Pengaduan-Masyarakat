                        ...
                        <div class="col-md-12">
                            <div class="card card-primary card-outline mt-5">
                                <div class="card-header">
                                    <h3 class="card-title">Details Pengaduan</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <?php $i = 1; ?>
                                        <tbody>
                                            <?php if($fetch_pengaduan !== null && isset($fetch_pengaduan)) :?>
                                            <tr>
                                                <td><?= $i++; ?></td>
                                                <td><?= $fetch_pengaduan->nama; ?></td>
                                                <td><?= $fetch_pengaduan->nik ?></td>
                                                <td><?= $fetch_pengaduan->isi_laporan; ?></td>
                                                <td><?= $fetch_pengaduan->tgl_pengaduan; ?></td>
                                                <td><button onclick="print()" class="btn btn-primary">Print</button>
                                                </td>
                                            </tr>
                                            <?php else: ?>
                                            <tr>
