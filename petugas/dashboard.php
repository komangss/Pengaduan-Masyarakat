                        ...
                        <div class="col-md-12">
                            <div class="card card-primary card-outline mt-5">
                                <div class="card-header">
                                    <h3 class="card-title">Semua Form Pengaduan</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img src="../assets/images/<?= $pengaduan->foto?>" alt="" srcset=""
                                                        style="width: 100%;">
                                                </td>
                                                <td>
                                                    <?php if($pengaduan->status == '0' ) : ?>
                                                    <a class="btn btn-danger"
                                                        href="proses-tanggapan.php?id_pengaduan=<?= $pengaduan->id_pengaduan?>">Menunggu</a>
                                                    <?php elseif($pengaduan->status == 'proses'): ?>
                                                    <a class="btn btn-info"
                                                        href="proses-tanggapan.php?id_pengaduan=<?= $pengaduan->id_pengaduan?>">Sedang
                                                        di
                                                        Proses</a>
                                                    <?php else : ?>
                                                    <a class="btn btn-success"
                                                        href="proses-tanggapan.php?id_pengaduan=<?= $pengaduan->id_pengaduan?>">Selesai</a>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <a class="btn btn-primary"
                                                        href="details-pengaduan.php?id_pengaduan=<?= $pengaduan->id_pengaduan?>">Detail
                                                    </a>
                                                </td>
                                            </tr>
                                        </tbody>
