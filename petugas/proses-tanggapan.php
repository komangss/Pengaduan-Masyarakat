        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <a href="" class="d-block">Petugas :
                            <?= $fetch_petugas->username; ?></a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary card-outline mt-3">
                                <h2 class="ml-3">
                                    <?= $fetch_pengaduan->status == '0' ? 'Menunggu' : (($fetch_pengaduan->status == 'proses') ? 'Sedang Diproses' : 'Selesai') ?>
                                </h2>
                                <div class="card-header">
                                    <h3 class="card-title">Form Pengaduan <b><?= $fetch_pengaduan->nama ?></b> </h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form
                                        action="../include/action/petugas/proses-tanggapan-action.php?id_pengaduan=<?= $fetch_pengaduan->id_pengaduan?>"
                                        method="post">
                                        <div class="form-group">
                                            <textarea id="compose-textarea" class="form-control" name="tanggapan">
                                            </textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="hidden" name="id_petugas" value="<?= $fetch_petugas->id_petugas?>">
                                </div>
                                <!-- /.card-body -->
